...
function populateSelects(){
  ...
  if(!$('#sessionDate').value)$('#sessionDate').value=new Date().toISOString().slice(0,10);if($('#extraDate')&&!$('#extraDate').value)$('#extraDate').value=new Date().toISOString().slice(0,10);
}
...
function renderSettings(){
  ...
  const build=$('#buildVersion');if(build)build.textContent='Versione 4.3';
}
