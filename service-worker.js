const C='attivamente-v3-20260817';
const A=['./','./index.html','./styles.css','./app.js','./config.js','./manifest.webmanifest','./assets/attivamente-brand.png','./assets/icon-180.png','./assets/icon-192.png','./assets/icon-512.png'];
